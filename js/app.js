...
class DETSimulator {
    ...
    renderCurrentQuestion() {
        ...
        const rendererMap = {
            ...
            'speaking-sample': renderers.renderSpeakingSample,
            'interactive-writing': renderers.renderInteractiveWriting,
            'interactive-reading': renderers.renderInteractiveReading,
            'interactive-listening': renderers.renderInteractiveListening,
            'interactive-speaking': renderers.renderInteractiveSpeaking,
            'read-speak': renderers.renderReadSpeak,
            'summarize-conversation': renderers.renderSummarizeConversation
        };
